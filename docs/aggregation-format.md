---
title: Aggregation Format
description: The KPL aggregated record wire format used by kinesis-producer, compatible with KCL deaggregation.
---

# KPL Aggregated Record Format

> Sourced from [amazon-kinesis-producer](https://github.com/awslabs/amazon-kinesis-producer/blob/master/aggregation-format.md).
...
- [Considerations When Using KPL Aggregation](http://docs.aws.amazon.com/kinesis/latest/dev/kinesis-producer-adv-aggregation.html) (AWS docs)
- [Consumer De-aggregation](http://docs.aws.amazon.com/kinesis/latest/dev/kinesis-kpl-consumer-deaggregation.html) (AWS docs)
- [aggregator.go](https://github.com/kinesis-producer-go/kinesis-producer/blob/main/aggregator.go) — this repo's implementation
